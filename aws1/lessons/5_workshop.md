  ...
  <div id="content-container">
    ...
    <section>
      ...
      <ol>
        ...
        <p>If you're confused about how to do this step, go look at <a href="#repeat">the screenshots</a> from the first time you did this.</p>
    ...
    "Statement": [
        {
            ...
            "Effect": "Allow",
            "Resource": "arn:aws:s3:::testpetrescue/*",
            "Principal": "*"
        }
    ]
}</pre>
