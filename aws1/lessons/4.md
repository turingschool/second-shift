  ...
  <div id="content-container">
    ...
    <section>
      ...
      <div class="try-it">
        ...
        <p>In sessions 1, 2, and 3, we worked with AWS's "serverfull" options. What might <span class="vocab">serverless</span> be referring to? With 1-2 people around you, take a minute to think about what this might mean.</p>
      </div>
    </section>
    <hr />
    <section>
