	...
	<div id="content-container">
		...
		<section>
			...
			<ul>
				...
				<li>In <b>Initial database name</b>, type "taskmanager" (without the quotes).</li>
  ...
  port: <%= ENV['RDS_PORT'] %></pre>
		...
		<section>
			...
			<ul>
				...
				<li>For the deploy stage, select <b>AWS Elastic Beanstalk</b>. in the dropdown.</li>
